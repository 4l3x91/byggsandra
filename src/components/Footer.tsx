...
const Footer = () => {
  ...
  return (
    <footer className="w-full flex flex-col lg:w-auto bg-purple-700 justify-center px-4 md:px-16 py-4 md:py-6 text-white">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          >
            Made with <FaHeart size={18} className="text-red-400 text-xl" /> by Appstract ©
            2023
          </a>
